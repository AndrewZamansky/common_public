...
#include  "src/I2S_i9xxxx.h"
	...
	#if ((1 == BYTES_PER_PCM_CHANNEL) || (2 == BYTES_PER_PCM_CHANNEL))
		#define I2S_I9XXXX_DT_ENABLE_CHANNEL_REORDERING  1
	#else
...
#ifndef I2S_I9XXXX_DT_DONT_ENABLE_PINOUT
	#define I2S_I9XXXX_DT_DONT_ENABLE_PINOUT  0
#endif
...
SET_STATIC_DEV_CONFIG(I2S_i9xxxx) =
{
	...
	I2S_I9XXXX_DT_DONT_ENABLE_PINOUT
};
...
#undef I2S_I9XXXX_DT_DONT_ENABLE_PINOUT
