...
#define MODULE_RUNTIME_DATA_STRUCT_TYPE     struct dma_i94xxx_runtime_t
	...
	#error "DMA_I94XXX_DT_PERIPHERAL_TYPE should be defined"
		...
		(DMA_I94XXX_DT_PERIPHERAL_TYPE == DMA_I94XXX_API_TYPE_DMIC) || \
	...
	#else
		EXTERN_DECLARATION_TO_STATIC_DEVICE_INST(DMA_I94XXX_DT_PERIPHERAL_DEV);
	...
	#endif
	#define DMA_I94XXX_DT_TRANSFER_WORD_SIZE  DMA_I94XXX_API_TRANSFER_WORD_32BIT
	...
	#ifndef DMA_I94XXX_DT_NUM_OF_PREFILLED_BUFFERS_BEFORE_TX_START
		#error "DMA_I94XXX_DT_NUM_OF_PREFILLED_BUFFERS_BEFORE_TX_START should be defined"
	#endif
#else
	#undef DMA_I94XXX_DT_NUM_OF_PREFILLED_BUFFERS_BEFORE_TX_START
	#define DMA_I94XXX_DT_NUM_OF_PREFILLED_BUFFERS_BEFORE_TX_START  0
#endif
...
#ifndef DMA_I94XXX_DT_NUM_OF_BUFFERS
	#error "DMA_I94XXX_DT_NUM_OF_BUFFERS should be defined"
#endif
...
#define STATIC_DEV_DATA_STRUCT             \
	{                                      \
		...
		DMA_I94XXX_DT_NUM_OF_BUFFERS,      \
		DMA_I94XXX_DT_NUM_OF_PREFILLED_BUFFERS_BEFORE_TX_START, \
...
#undef _DMA_I94XXX_PERIPHERAL_PDEV
#undef DMA_I94XXX_DT_NUM_OF_BUFFERS
#undef DMA_I94XXX_DT_NUM_OF_PREFILLED_BUFFERS_BEFORE_TX_START
