...
#if ( (DMA_I9XXXX_DT_PERIPHERAL_TYPE == DMA_I9XXXX_API_TYPE_I2S_TX) || \
		(DMA_I9XXXX_DT_PERIPHERAL_TYPE == DMA_I9XXXX_API_TYPE_I2S_RX) || \
		(DMA_I9XXXX_DT_PERIPHERAL_TYPE == DMA_I9XXXX_API_TYPE_DPWM) || \
		(DMA_I9XXXX_DT_PERIPHERAL_TYPE == DMA_I9XXXX_API_TYPE_DMIC) || \
		(DMA_I9XXXX_DT_PERIPHERAL_TYPE == DMA_I9XXXX_API_TYPE_SPI1_RX) || \
		(DMA_I9XXXX_DT_PERIPHERAL_TYPE == DMA_I9XXXX_API_TYPE_SPI1_TX) || \
		(DMA_I9XXXX_DT_PERIPHERAL_TYPE == DMA_I9XXXX_API_TYPE_SPI2_RX) || \
		(DMA_I9XXXX_DT_PERIPHERAL_TYPE == DMA_I9XXXX_API_TYPE_SPI2_TX) )
