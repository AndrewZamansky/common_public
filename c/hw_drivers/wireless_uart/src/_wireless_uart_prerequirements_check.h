...
typedef struct dev_desc_t *   			_if_fail_here_then___pdev_descriptor___is_not_defined_in_wireless_uart_config_h;
typedef dev_param_t   				_if_fail_here_then___dev_param_t___is_not_defined_in_wireless_uart_config_h;


typedef struct ioctl_get_data_buffer_t    	_if_fail_here_then___ioctl_get_data_buffer_t___is_not_defined_in_shell_config_h;
