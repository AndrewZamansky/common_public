...
extern uint8_t wireless_uart_ioctl( struct dev_desc_t *adev ,const uint8_t aIoctl_num
		, void * aIoctl_param1  , void * aIoctl_param2);
extern uint8_t wireless_uart_callback(struct dev_desc_t *adev ,
...
#define __UART_WIRELESS_UART_API_CREATE_STATIC_DEV(dev,dev_name, uart_wrapper_server_dev, callback_dev)\
		...
		extern const struct dev_desc_t uart_wrapper_server_dev ;			\
