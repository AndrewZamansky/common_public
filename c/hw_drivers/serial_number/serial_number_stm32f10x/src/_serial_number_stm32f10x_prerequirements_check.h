/*
 * file : serial_number_stm32f10x_prerequirements_check.h
 *
 *
 *
 *
...
#ifndef _serial_number_stm32f10x_prerequirements_check_H
#define _serial_number_stm32f10x_prerequirements_check_H
...
typedef struct dev_desc_t *   			_if_fail_here_then___pdev_descriptor___is_not_defined_in_serial_number_config_h;
