/*
 * file : LM35_prerequirements_check.h
 *
 *
 *
 *
...
#ifndef _LM35_prerequirements_check_H
...
typedef pdev_descriptor   			_if_fail_here_then___pdev_descriptor___is_not_defined_in_LM35_config_h;
