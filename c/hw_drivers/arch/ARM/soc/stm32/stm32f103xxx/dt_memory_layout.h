...
#if (defined(CONFIG_STM32F103x8_20K_SRAM) || \
		defined(CONFIG_STM32F103xB_20K_SRAM))
	#define DT_INTERNAL_SRAM_MEMORY_SIZE   0x5000
#elif defined(CONFIG_STM32F103xC_64K_SRAM)
...
#if defined(CONFIG_STM32F103x8_64K_FLASH)
	#define DT_INTERNAL_FLASH_MEMORY_SIZE   0x10000
#elif defined(CONFIG_STM32F103xB_128K_FLASH)
	#define DT_INTERNAL_FLASH_MEMORY_SIZE   0x20000
#elif defined(CONFIG_STM32F103xC_256K_FLASH)
