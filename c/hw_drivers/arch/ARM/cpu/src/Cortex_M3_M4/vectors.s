...
#ifndef CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS
 .err
 .print "!! CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS should be defined  !!"
 .end
#endif

#if (CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS < 32)
	#define BYTES_TO_KEEP_FOR_VECTOR_SPACE	128
#elif  (CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS < 64)
	#define BYTES_TO_KEEP_FOR_VECTOR_SPACE	256
#elif  (CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS < 96)
	#define BYTES_TO_KEEP_FOR_VECTOR_SPACE	384
#elif  (CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS < 128)
	#define BYTES_TO_KEEP_FOR_VECTOR_SPACE	512
#elif  (CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS < 160)
	#define BYTES_TO_KEEP_FOR_VECTOR_SPACE	640
#elif  (CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS < 192)
	#define BYTES_TO_KEEP_FOR_VECTOR_SPACE	768
#elif  (CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS < 224)
	#define BYTES_TO_KEEP_FOR_VECTOR_SPACE	896
#elif  (CONFIG_DT_NUMBER_OF_EXTERNAL_INTERRUPTS < 256)
