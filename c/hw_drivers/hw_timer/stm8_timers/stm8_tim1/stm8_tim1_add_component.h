...
uint8_t stm8_tim1_ioctl( pdev_descriptor_t apdev ,const uint8_t aIoctl_num , void * aIoctl_param1 , void * aIoctl_param2);
...
#define MODULE_CONFIG_DATA_STRUCT_TYPE	stm8_tim1_instance_t
	...
	#define STATIC_DEV_DATA_STRUCT 	{	\
		...
		((STM8_TIM1_DT_PARENT_CLOCK_RATE /2 )/ STM8_TIM1_DT_INITIAL_RATE ),	\
