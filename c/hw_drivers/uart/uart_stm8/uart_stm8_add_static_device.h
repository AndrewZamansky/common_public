...
#ifndef UART_STM8_DT_DEV_NAME
#error "UART_STM8_DT_DEV_NAME should be defined"
#endif
...
UART_STM8_Instance_t STATIC_DEVICE_INNER_INST(UART_STM8_DT_DEV_NAME) =
	{
		P_TO_STATIC_DEVICE_INST(UART_STM8_DT_CALLBACK_PDEV),
		UART_STM8_DT_BAUD_RATE
	};
CREATE_STATIC_DEVICE(UART_STM8_DT_DEV_NAME , &STATIC_DEVICE_INNER_INST(UART_STM8_DT_DEV_NAME) ,
	uart_stm8_ioctl , uart_stm8_pwrite ,
