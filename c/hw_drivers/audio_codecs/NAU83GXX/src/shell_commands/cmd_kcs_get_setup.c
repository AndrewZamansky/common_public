...
int do_kcs_get_setup(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
	...
	rc = DEV_IOCTL(kcs_dev, IOCTL_KCS_GET_SETUP_CMD, &kcs_cmd_get_ioctl);
...
U_BOOT_CMD(
    kcs_get_setup, 255, 0, do_kcs_get_setup,
	"",
	""
);
