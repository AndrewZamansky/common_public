...
#ifndef  NAU83GXX_DT_POSSIBLE_I2C_ADDR_ARR
	#error "NAU83GXX_DT_POSSIBLE_I2C_ADDR_ARR should be defined"
#else
	DECLARE_DT_UINT8_ARRAY(i2c_addr_arr, NAU83GXX_DT_POSSIBLE_I2C_ADDR_ARR);
#endif

#ifndef  NAU83GXX_DT_CHIP_TYPE
	#define NAU83GXX_DT_CHIP_TYPE  NAU83GXX_CHIP_TYPE_AUTO_DETECT
#endif
...
#ifndef  NAU83GXX_DT_I2S_BUS_TYPE
	#error "NAU83GXX_DT_I2S_BUS_TYPE should be defined"
#endif

#ifndef  NAU83GXX_DT_I2S_WORD_SIZE_IN_BYTES
	#error "NAU83GXX_DT_I2S_WORD_SIZE_IN_BYTES should be defined"
#endif
...
SET_STATIC_DEV_CONFIG(NAU83GXX) =
{
	...
	DT_UINT8_ARRAY_SIZE(i2c_addr_arr),
	DT_ARRAY_NAME(i2c_addr_arr),
	NAU83GXX_DT_CHIP_TYPE,
	NAU83GXX_DT_I2S_BUS_TYPE,
	NAU83GXX_DT_I2S_IN_CHANNEL,
	NAU83GXX_DT_I2S_WORD_SIZE_IN_BYTES,
...
#undef  NAU83GXX_DT_POSSIBLE_I2C_ADDR_ARR
#undef NAU83GXX_DT_CHIP_TYPE
#undef NAU83GXX_DT_I2S_BUS_TYPE
