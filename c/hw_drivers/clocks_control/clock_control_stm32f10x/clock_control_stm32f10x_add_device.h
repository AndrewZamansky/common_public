...
#ifndef CLOCK_CONTROL_STM32f10X_DT_HIRC_RATE
	#error "CLOCK_CONTROL_STM32f10X_DT_HIRC_RATE should be defined"
#endif

#ifndef CLOCK_CONTROL_STM32f10X_DT_LIRC_RATE
	#error "CLOCK_CONTROL_STM32f10X_DT_LIRC_RATE should be defined"
#endif

#ifndef CLOCK_CONTROL_STM32f10X_DT_XTAL_RATE
	#define CLOCK_CONTROL_STM32f10X_DT_XTAL_RATE  0
	#warning "CLOCK_CONTROL_STM32f10X_DT_XTAL_RATE not defined"
#endif
...
#ifndef CLOCK_CONTROL_STM32f10X_DT_APB1_RATE
	#error "CLOCK_CONTROL_STM32f10X_DT_APB1_RATE should be defined"
#endif

#ifndef CLOCK_CONTROL_STM32f10X_DT_APB2_RATE
	#error "CLOCK_CONTROL_STM32f10X_DT_APB2_RATE should be defined"
#endif
...
SET_STATIC_DEV_CONFIG(clock_control_stm32f10x) =
{
	CLOCK_CONTROL_STM32f10X_DT_HIRC_RATE,
	CLOCK_CONTROL_STM32f10X_DT_LIRC_RATE,
	CLOCK_CONTROL_STM32f10X_DT_XTAL_RATE,
	CLOCK_CONTROL_STM32f10X_DT_PLL_RATE,
	CLOCK_CONTROL_STM32f10X_DT_HCLK_RATE,
	CLOCK_CONTROL_STM32f10X_DT_APB1_RATE,
	CLOCK_CONTROL_STM32f10X_DT_APB2_RATE,
 ...
 */
#undef CLOCK_CONTROL_STM32f10X_DT_XTAL_RATE
