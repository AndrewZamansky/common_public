/*
 *
 * file :   clocks_control_xtensa_fpga.c
 *
 *
 */
...
#include "clock_control_xtensa_fpga.h"

#include "_clock_control_xtensa_fpga_prerequirements_check.h"
...
uint8_t clock_xtensa_fpga_core_clk_ioctl( struct dev_desc_t *adev,
...
/**
 * clock_control_xtensa_fpga_ioctl()
 *
 * return:
 */
uint8_t clock_control_xtensa_fpga_ioctl( struct dev_desc_t *adev,
		const uint8_t aIoctl_num, void * aIoctl_param1,
		void * aIoctl_param2)
{
//	struct clk_cntl_xtensa_fpga_cfg_t *cfg_hndl;
//	uint32_t rate;
//	struct dev_desc_t	*parent_clk_dev;
//
