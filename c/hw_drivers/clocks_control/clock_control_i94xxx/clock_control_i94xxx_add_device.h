...
#if !defined(CLOCK_CONTROL_I94XXX_EXT_RATE) || \
				( 0 == CLOCK_CONTROL_I94XXX_EXT_RATE)
	#warning "CLOCK_CONTROL_I94XXX_EXT_RATE no defined or 0"
	#define CLOCK_CONTROL_I94XXX_EXT_RATE  0
