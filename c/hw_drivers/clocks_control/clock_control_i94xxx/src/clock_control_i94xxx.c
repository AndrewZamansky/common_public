...
/*---------------------------------------------------------------------------------------------------------*/
/* Function:        clocks_control_i94xxx_ioctl                                                                          */
/*                                                                                                         */
/* Parameters:                                                                                             */
/*                                                                                         */
/*                                                                                                  */
...
/*                                                            						 */
/*---------------------------------------------------------------------------------------------------------*/
uint8_t clock_control_i94xxx_ioctl( pdev_descriptor_t apdev ,const uint8_t aIoctl_num
		, void * aIoctl_param1 , void * aIoctl_param2)
{
	...
	switch(aIoctl_num)
	{
		...
		case IOCTL_DEVICE_START :
			for(clock_index =0; clock_index < I94XXX_TOTAL_NUM_OF_CLOCKS ; clock_index++)
			{
