...
ifdef CONFIG_INCLUDE_UBOOT_SHELL
    GLOBAL_INCLUDE_DIR := $(call ADD_TO_GLOBAL_INCLUDE_PATH ,  $(SW_PACKAGES_ROOT_DIR)/u_boot_shell/include )
    GLOBAL_INCLUDE_DIR := $(call ADD_TO_GLOBAL_INCLUDE_PATH , $(EXTERNAL_SOURCE_ROOT_DIR)/u-boot/include)
endif
#DEFINES = 
