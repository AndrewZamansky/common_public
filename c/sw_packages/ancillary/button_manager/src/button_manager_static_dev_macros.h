...
extern uint8_t button_manager_ioctl(struct dev_desc_t *adev ,const uint8_t aIoctl_num ,
		void* aIoctl_param1,void* aIoctl_param2);
extern uint8_t button_manager_callback(struct dev_desc_t *adev ,const uint8_t aCallback_num ,
