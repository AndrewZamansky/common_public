...
typedef struct dev_desc_t *   		_if_fail_here_then___pdev_descriptor___is_not_defined_in_button_manager_config_h;
typedef struct dev_param_t   		_if_fail_here_then___dev_param_t___is_not_defined_in_button_manager_config_h;
