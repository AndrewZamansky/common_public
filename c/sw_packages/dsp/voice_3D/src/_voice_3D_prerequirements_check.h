...
typedef uint32_t   					_if_fail_here_then___uint32_t___is_not_defined_in_voice_3D_config_h;
typedef pdsp_descriptor   			_if_fail_here_then___pdsp_descriptor___is_not_defined_in_voice_3D_config_h;
typedef dsp_param_t   				_if_fail_here_then___dsp_param_t___is_not_defined_in_voice_3D_config_h;


typedef ioctl_get_data_buffer_t    	_if_fail_here_then___ioctl_get_data_buffer_t___is_not_defined_in_voice_3D_config_h;
...
enum
{
	...
	IOCTL_LAST_COMMON_IOCTL_not_declared_in_voice_3D_config_h=sizeof((int)IOCTL_LAST_COMMON_IOCTL),
#endif
#ifndef DEV_CALLBACK_1_PARAMS
	DEV_CALLBACK_1_PARAMS_not_declared_in_voice_3D_config_h=sizeof((int)DEV_CALLBACK_1_PARAMS),
#endif
...
#ifndef busy_delay
	busy_delay___declared_in_voice_3D_config_h=sizeof((int)busy_delay)
#endif
