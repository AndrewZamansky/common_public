...
static fix16_t fix_8_fix16_t    = fix_8;
...
#if defined(CONFIG_USE_NATURE_DSP)
	...
	static inline fix16_t log2_32(int32_t value)
	{
		int32_t ret;
		value = value >> 1;
		ret = scl_log2_32x32(value);
		return ret;//(ret >> 9);  // return Q6.25
	}
	...
	{
		int32_t ret_val;
		//value = value << 9;  // receive as input Q6.25
		ret_val = scl_antilog2_32x32(value);
		return (ret_val << 1);
	}
