...
typedef enum
{
	...
	CALLBACK_TX_BUFFER_UNDERFLOW,
	CALLBACK_TX_BUFFER_UNDERFLOW_THRESHOLD_REACHED,
	CALLBACK_TX_BUFFER_OVERFLOW,
	CALLBACK_TX_BUFFER_OVERFLOW_THRESHOLD_REACHED,
	CALLBACK_RX_BUFFER_OVERFLOW,
	CALLBACK_RX_BUFFER_UNDERFLOW,
