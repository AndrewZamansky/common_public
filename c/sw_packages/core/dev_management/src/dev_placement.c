...
#include "arch.h"
	...
	uint32_t START_OF_DEVICE_TREE_PLACEMENT		start_of_device_tree_stamp =0;
	uint8_t END_OF_DEVICE_TREE_PLACEMENT
						end_of_device_tree_stamp = END_OF_DEVICE_TREE_STAMP ;
