...
#include "dev_management_api.h"
	...
	#define MODULE_PARAMS_ARR(module)		MODULE_PARAMS_ARR2(module)
			...
			dev_param_t const MODULE_PARAMS_ARR(MODULE_NAME)[] = MODULE_CONFIGURABLE_PARAMS_ARRAY;
			#define	POINTER_TO_CONFIGURABLE_PARAMS_ARRAY			MODULE_PARAMS_ARR(MODULE_NAME)
			#define	SIZE_OF_POINTER_TO_CONFIGURABLE_PARAMS_ARRAY	sizeof(MODULE_PARAMS_ARR(MODULE_NAME))/sizeof(dev_param_t)
		#else
