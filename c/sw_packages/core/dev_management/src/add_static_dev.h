...
#define DEV_INNER_INST2(pdev)	inner_inst_##pdev
	...
	MODULE_DATA_STRUCT_TYPE	 DEVICE_DATA_PLACEMENT	DEV_INNER_INST(DT_DEV_NAME) = STATIC_DEV_DATA_STRUCT;
...
#define	_MODULE_NAME2(module,pdev)		module##pdev##str
