...
AUTO_INIT_WITHOUT_BOUNDS +=$(CONFIG_XTENSA_XCC) $(CONFIG_XTENSA_CLANG)
...
USE_ARMCC_AUTO_INIT_HELPER :=$(strip $(CONFIG_ARMCC))
...
ifeq ($(USE_ARMCC_AUTO_INIT_HELPER),y)
