...
#define HEARTBEAT_API_CREATE_STATIC_DEV(pdev , heartbeat_callback , callibration_timer_pdev ) \
			__HEARTBEAT_API_CREATE_STATIC_DEV(pdev , heartbeat_callback , callibration_timer_pdev)
