...
// HOST IN
	...
	#define  USB_AUDIO_CLASS_DT_REC_MAX_VOLUME_db         0.0f

	#undef   USB_AUDIO_CLASS_DT_REC_MIN_VOLUME_db
	#define  USB_AUDIO_CLASS_DT_REC_MIN_VOLUME_db         0.0f

	#undef   USB_AUDIO_CLASS_DT_REC_VOLUME_RESOLUTION_db
	#define  USB_AUDIO_CLASS_DT_REC_VOLUME_RESOLUTION_db  0.0f
#endif
