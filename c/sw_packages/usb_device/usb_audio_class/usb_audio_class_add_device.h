...
#ifndef USB_AUDIO_CLASS_DT_CONTROL_CALLBACK_PDEV
	#define _USB_AUDIO_CLASS_CONTROL_CALLBACK_PDEV   NULL
#else
	EXTERN_DECLARATION_TO_STATIC_DEVICE_INST(
						USB_AUDIO_CLASS_DT_CONTROL_CALLBACK_PDEV);
	#define _USB_AUDIO_CLASS_CONTROL_CALLBACK_PDEV     \
		P_TO_STATIC_DEVICE_INST(USB_AUDIO_CLASS_DT_CONTROL_CALLBACK_PDEV)
#endif
...
// HOST IN
	...
	#ifndef USB_AUDIO_CLASS_DT_NUM_OF_TX_BUFFERS
		#error "USB_AUDIO_CLASS_DT_NUM_OF_TX_BUFFERS should be defined"
	#endif
	...
	#ifndef USB_AUDIO_CLASS_DT_HOST_IN_TERMINAL_TYPE
		#error "USB_AUDIO_CLASS_DT_HOST_IN_TERMINAL_TYPE should be defined"
	#endif

	#ifndef USB_AUDIO_CLASS_DT_REC_MAX_VOLUME_db
		#define  USB_AUDIO_CLASS_DT_REC_MAX_VOLUME_db         0.0f // in db
	#endif
	#ifndef USB_AUDIO_CLASS_DT_REC_MIN_VOLUME_db
		#define  USB_AUDIO_CLASS_DT_REC_MIN_VOLUME_db        -64.0f // in db
	#endif
	#ifndef USB_AUDIO_CLASS_DT_REC_VOLUME_RESOLUTION_db
		#define  USB_AUDIO_CLASS_DT_REC_VOLUME_RESOLUTION_db  1.0f  // in db
	#endif
#else
	#undef   USB_AUDIO_CLASS_DT_GET_TX_BUFFER_SIZE
	#define  USB_AUDIO_CLASS_DT_GET_TX_BUFFER_SIZE  0

	#undef   USB_AUDIO_CLASS_DT_NUM_OF_TX_BUFFERS
	#define  USB_AUDIO_CLASS_DT_NUM_OF_TX_BUFFERS 0
	...
	#undef   USB_AUDIO_CLASS_DT_HOST_IN_TERMINAL_TYPE
	#define  USB_AUDIO_CLASS_DT_HOST_IN_TERMINAL_TYPE  0

	#undef   USB_AUDIO_CLASS_DT_REC_MAX_VOLUME_db
	#define  USB_AUDIO_CLASS_DT_REC_MAX_VOLUME_db         0.0f // in db

	#undef   USB_AUDIO_CLASS_DT_REC_MIN_VOLUME_db
	#define  USB_AUDIO_CLASS_DT_REC_MIN_VOLUME_db         -64.0f // in db

	#undef   USB_AUDIO_CLASS_DT_REC_VOLUME_RESOLUTION_db
	#define  USB_AUDIO_CLASS_DT_REC_VOLUME_RESOLUTION_db  1.0f // in db
#endif
...
// HOST OUT
	...
	#ifndef USB_AUDIO_CLASS_DT_HOST_OUT_TERMINAL_TYPE
		#error "USB_AUDIO_CLASS_DT_HOST_OUT_TERMINAL_TYPE should be defined"
	#endif

	#ifndef USB_AUDIO_CLASS_DT_PLAYBACK_MAX_VOLUME_db
		#define  USB_AUDIO_CLASS_DT_PLAYBACK_MAX_VOLUME_db       0.0f // in db
	#endif
	#ifndef USB_AUDIO_CLASS_DT_PLAYBACK_MIN_VOLUME_db
		#define  USB_AUDIO_CLASS_DT_PLAYBACK_MIN_VOLUME_db      -64.0f // in db
	#endif
	#ifndef USB_AUDIO_CLASS_DT_PLAYBACK_VOLUME_RESOLUTION_db
		#define  USB_AUDIO_CLASS_DT_PLAYBACK_VOLUME_RESOLUTION_db  1.0f // in db
	#endif
	...
	#undef   USB_AUDIO_CLASS_DT_HOST_OUT_TERMINAL_TYPE
	#define  USB_AUDIO_CLASS_DT_HOST_OUT_TERMINAL_TYPE  0

	#undef   USB_AUDIO_CLASS_DT_PLAYBACK_MAX_VOLUME_db
	#define  USB_AUDIO_CLASS_DT_PLAYBACK_MAX_VOLUME_db         0.0f

	#undef   USB_AUDIO_CLASS_DT_PLAYBACK_MIN_VOLUME_db
	#define  USB_AUDIO_CLASS_DT_PLAYBACK_MIN_VOLUME_db         0.0f

	#undef   USB_AUDIO_CLASS_DT_PLAYBACK_VOLUME_RESOLUTION_db
	#define  USB_AUDIO_CLASS_DT_PLAYBACK_VOLUME_RESOLUTION_db  0.0f

#endif

// frame = num_of_channels * size_of_channel
#define _USB_AUDIO_CLASS_FRAME_SIZE  (USB_AUDIO_CLASS_DT_NUM_OF_RX_CHANNELS * \
...
SET_STATIC_DEV_CONFIG(usb_audio_class) =
{
	...
	USB_AUDIO_CLASS_DT_REC_MAX_VOLUME_db,
	USB_AUDIO_CLASS_DT_REC_MIN_VOLUME_db,
	USB_AUDIO_CLASS_DT_REC_VOLUME_RESOLUTION_db,
	...
	USB_AUDIO_CLASS_DT_PLAYBACK_MAX_VOLUME_db,
	USB_AUDIO_CLASS_DT_PLAYBACK_MIN_VOLUME_db,
	USB_AUDIO_CLASS_DT_PLAYBACK_VOLUME_RESOLUTION_db,
};
...
#undef _USB_AUDIO_CLASS_CONTROL_CALLBACK_PDEV
#undef USB_AUDIO_CLASS_DT_CONTROL_CALLBACK_PDEV
...
#undef USB_AUDIO_CLASS_DT_HOST_IN_TERMINAL_TYPE
#undef USB_AUDIO_CLASS_DT_HOST_OUT_TERMINAL_TYPE
#undef _USB_AUDIO_CLASS_FRAME_SIZE
