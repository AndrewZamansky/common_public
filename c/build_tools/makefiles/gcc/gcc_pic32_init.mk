...
ifdef REDEFINE_PIC32_GCC_ROOT_DIR
    ...
    ifeq ("$(wildcard $(REDEFINE_PIC32_GCC_ROOT_DIR))","")
        ...
        $(info !--- to use default pic32 gcc location remove/comment REDEFINE_PIC32_GCC_ROOT_DIR variable in  $(WORKSPACE_ROOT_DIR)/workspace_config.mk )
        $(info !--- you can set customized gcc path in REDEFINE_PIC32_GCC_ROOT_DIR variable in $(WORKSPACE_ROOT_DIR)/workspace_config.mk )
        $(error )
    else
    ...
    ifdef CONFIG_PIC32_COMPILER_LOCATION_WINDOWS_DEFAULT
        ...
        ifdef GCC_NOT_FOUND
            ...
            $(info !--- or use set CONFIG_PIC32_COMPILER_LOCATION_WORKSPACE_TOOLS_DIRECTORY in menuconfig   )
            $(info !--- you can also set customized gcc path in REDEFINE_PIC32_GCC_ROOT_DIR variable in $(WORKSPACE_ROOT_DIR)/workspace_config.mk )
            $(error )
        endif
