...
ifdef CONFIG_MCC_OUTPUT_TYPE_EXE
    ...
    LINKER_OUTPUT_NAMED := $(OUT_DIR)/$(PROJECT_NAME).$(ARCH_NAME).exe
    OUTPUT_BIN := $(OUT_DIR)/$(OUTPUT_APP_NAME).stripped.exe
    LINKER_HISTORY_OUTPUT := $(OUT_DIR_HISTORY)/$(PROJECT_NAME).$(ARCH_NAME)_$(MAIN_VERSION_STR).exe
    OUTPUT_HISTORY_BIN :=  $(OUT_DIR_HISTORY)/$(PROJECT_NAME).$(ARCH_NAME)_$(MAIN_VERSION_STR)r$(DATE_STR).stripped.exe
endif

ifdef CONFIG_MCC_OUTPUT_TYPE_DLL
    LINKER_OUTPUT := $(OUT_DIR)/$(OUTPUT_APP_NAME).dll
    LINKER_LIB_OUTPUT := $(OUT_DIR)/$(OUTPUT_APP_NAME).lib
    LINKER_OUTPUT_NAMED := $(OUT_DIR)/$(PROJECT_NAME).$(ARCH_NAME).dll
    LINKER_HISTORY_OUTPUT := $(OUT_DIR_HISTORY)/$(PROJECT_NAME).$(ARCH_NAME)_$(MAIN_VERSION_STR).dll
    OUTPUT_HISTORY_BIN :=  $(OUT_DIR_HISTORY)/$(PROJECT_NAME).$(ARCH_NAME)_$(MAIN_VERSION_STR)r$(DATE_STR).stripped.dll
endif
