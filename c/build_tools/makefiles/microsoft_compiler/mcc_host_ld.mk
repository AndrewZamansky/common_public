...
ifdef CONFIG_MCC_OUTPUT_TYPE_EXE
    ...
    LINKER_HISTORY_OUTPUT := $(OUT_DIR_HISTORY)/$(PROJECT_NAME).$(ARCH_NAME).$(MAIN_VERSION_STR).exe
endif
...
ifdef CONFIG_MCC_OUTPUT_TYPE_DLL
    ...
    LINKER_HISTORY_OUTPUT := $(OUT_DIR_HISTORY)/$(PROJECT_NAME).$(ARCH_NAME).$(MAIN_VERSION_STR).dll
endif
