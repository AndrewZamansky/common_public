...
ifdef CONFIG_ARM
    ifdef CONFIG_GCC
        include $(MAKEFILES_ROOT_DIR)/compilers/gcc/gcc_cc.mk
    else ifdef CONFIG_GPP
        include $(MAKEFILES_ROOT_DIR)/compilers/gcc/gcc_cc.mk
    else ifdef CONFIG_ARMCC
        include $(MAKEFILES_ROOT_DIR)/compilers/armcc/armcc_cc.mk
    endif
    ...
    include $(MAKEFILES_ROOT_DIR)/compilers/cxstm8/cxstm8_cc.mk
else ifdef CONFIG_HEXAGON
    include $(MAKEFILES_ROOT_DIR)/compilers/clang/clang_hexagon_cc.mk
    ...
    ifeq ($(findstring WINDOWS,$(COMPILER_HOST_OS)),WINDOWS)
        ifdef CONFIG_MIN_GW_GCC
            ...
            include $(MAKEFILES_ROOT_DIR)/compilers/microsoft_compiler/msvc_cc.mk
        endif
    else
        include $(MAKEFILES_ROOT_DIR)/compilers/gcc/gcc_cc.mk
    endif
